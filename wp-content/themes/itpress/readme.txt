...
ITpress WordPress Theme, Copyright 2021 Burger Software
...
@version 1.0.12
* Checked Compatibility by WordPress 5.7.2

@version 1.0.11
* Checked Compatibility by WordPress 5.7.1

@version 1.0.10
* Default Image Added in Header Contact Icon
...
@version 1.0.7
* Improved Header Navigation Contact Code
