...
Spintech WordPress Theme, Copyright 2021 Burger Software
...
@version 1.0.24
* Checked Compatibility by WordPress 5.7.1

@version 1.0.23
* Fixed Post Navigation Links Styles Issue

@version 1.0.22
* Breadcrumb Title Functionality Improved

@version 1.0.21
* Checked Compatiblity With WordPress 5.7
...
* Copyright Year Updated in Readme

@version 1.0.18
* Javascript Issue Fixed
* Customizer Sections Seperated
